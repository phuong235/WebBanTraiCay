    	...
    	if($('.product-grid').length)
    	{
    		$('.product-grid').isotope({
	            ...
	            getSortData: {
	            	...
	            	{
						var priceEle = $(itemElement).find('.filter_product_price').text().replace('đ', '');
						var g = parseFloat(priceEle);
	        ...
	        filterButton.on('click', function()
	        {
	        	$('.product-grid').isotope({
		            filter: function()
		            {
						...
						var itemPrice = $(this).find('.filter_product_price').clone().children().remove().end().text();
